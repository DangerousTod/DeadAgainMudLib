//    A further advancement on code found in Well_lever
//    and grate. The bolt shoots from the door into a slot 
//    in the wall using PRESS and PULL.
//    Vulture@DeadAgain 12-20-16
#include <lib.h>
inherit LIB_DUMMY;
inherit LIB_PULL;
inherit LIB_PRESS;
...
int unlockDoor(object who) {
	object door = load_object("/domains/urmil/doors/cell_1.c");
	if(!door->GetLocked()){
