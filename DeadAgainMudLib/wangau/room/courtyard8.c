...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/wangau/room/courtyard5",
        "east" : "/domains/wangau/room/courtyard7",
        "west" : "/domains/wangau/room/courtyard9",
        "northwest" : "/domains/wangau/room/courtyard4",
        "northeast" : "/domains/wangau/room/courtyard6.c",
      ]) );
