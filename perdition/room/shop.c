...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/perdition/room/city_street1",
        "up" : "/domains/perdition/room/shop2.c",
      ]) );
    SetInventory(([
        "/domains/town/obj/bbucket" : 1,
        "/domains/perdition/npc/otik" : ({60, 1}),
      ]));
    SetRead("sign", (: read_sign :) );

    SetDoor("down", "/domains/perdition/doors/otik_d.c");
