...
void create() {
    ...
    SetExits( 
		(["south" : "/domains/perdition/room/fighter_e"]) );
	AddExit("up", "/domains/perdition/room/fighter_hall.", (:go_up:));
    SetListen("default", "Fighters are yelling and screaming and "
            "being generally obnoxiously loud.");
	SetDoor("south", "/domains/perdition/doors/fighter_door.c"); 
}
...
int become(string str) {
	...
	this_player()->setenv("start", "/domains/perdition/room/fighter_hall");
    return 1;
}
