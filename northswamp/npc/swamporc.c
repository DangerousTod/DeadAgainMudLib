...
static void create() {
    ...
    SetGuard("west", "An orc bars your way!" );
	 SetGuard("northeast", "An orc bars your way!");
	SetGuard("east", "An orc bars your way!");
	SetGuard("northwest", "An orc bars your way!");
	SetGuard("north", "An orc bars your way!");
	SetGuard("south", "An orc bars your way!");
	SetGuard("southeast", "an orc bars your way!");
	SetGuard("southwest", "An orc bars your way!");
}
void init(){
    ::init();
}
